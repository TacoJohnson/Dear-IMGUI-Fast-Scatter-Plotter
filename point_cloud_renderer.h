...
struct Point3D {
  ...
  Point3D(float x = 0, float y = 0, float z = 0, float r = 1, float g = 1,
          float b = 1, float intensity = 1.0f)
...
public:
  ...
  void getProjectionMatrices(float modelview[16], float projection[16],
